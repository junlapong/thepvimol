...
<?php
	...
	${$col}[1]=array("name"=>"pr_no","type"=>"string" ,"editor"=>"textFieldBlank,width:80");		
	${$col}[2]=array("name"=>"pr_date","type"=>"string" ,"editor"=>"textFieldBlank,width:80");		
	...
	${$col}[3]=array("name"=>"item_name","type"=>"string","editor"=>"textFieldBlank,width:140","df"=>"" );						
	${$col}[4]=array("name"=>"order_qty","type"=>"string","editor"=>"textFieldBlank,width:80","df"=>"" );
