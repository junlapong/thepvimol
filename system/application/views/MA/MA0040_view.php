...
<?php
	...
	${$col}[2]=array("name"=>"group_code","type"=>"string","editor"=>"groupCombo,width:180","df"=>"" );						
...
Ext.onReady(function(){
	...
	var groupStore = new Ext.data.JsonStore({
	    root: 'data',
	    idProperty: 'group_code',  //<-- Primary key
	...
	var groupCombo = new Object();		
	groupCombo["xtype"] = 'combo';
	groupCombo["displayField"] = 'group_code';
	groupCombo["valueField"] = 'group_code';
	groupCombo["mode"] = 'local';
	groupCombo["allowBlank"] = false;
	groupCombo["typeAhead"] = true;
	groupCombo["triggerAction"] = 'all';
	groupCombo["store"] = groupStore;
	groupCombo["selectOnFocus"] = true;
	groupCombo["forceSelection"] = true;
	groupCombo["minChars"] = 2;
	groupCombo["editable"] = false;
	groupCombo["listeners"] = {show:{fn:function(combo) {
		var leftGrid = gridur;
...
//_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_
	...
	function onSelectEvent<?=$gname?>(sm,row,rec){
        ...
        upDataStore.load(obj); // Update data
        upEnableButton(false); // Enable Button
