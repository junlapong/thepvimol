...
<?php
	...
	//left array						
	${$col}[0]	=	array("name"=>	"group_code","type"=>	"string" ,"editor"=>"textFieldBlank,width:150");										
	...
	${$col}[1]=array("name"=>"group_code","type"=>"string","editor"=>"textFieldBlank, hidden: true , hideable: false","df"=>"*DF*selGroup" );						
...
var groupField = formTextField1(true,false,'group_code','<?=lang('group_code')?>');	
...
menuCombo["listeners"] = {show:{fn:function(combo) {
	...
	var obj = new Object();
	    ...
	    obj["params"]["group_code"] = values['group_code'];
