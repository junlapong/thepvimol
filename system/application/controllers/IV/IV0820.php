 ...
 *------------------------------------------------------------------------------
 */
class IV0820 extends MY_Controller {
	...
	function getUIReasonCombo()
	{
		...
		if($_POST != NULL) {
			...
			$ret['data'] = $this->common->getSiComboList()->result_array();
	...
	function insertLedger()
	{
		...
		if($_POST != NULL) {
			...
			$issuType = "P";//$this->input->post('issu_type_v');
			$issuReason = "si_reason-1";//$this->input->post('ui_reason_val');
