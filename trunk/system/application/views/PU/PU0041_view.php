...
<?php
	...
	${$col}[1]=array("name"=>"po_no","type"=>"string" ,"editor"=>"textFieldBlank,width:80");		
	${$col}[2]=array("name"=>"po_date","type"=>"string" ,"editor"=>"textFieldBlank,width:80");		
	//${$col}[3]=array("name"=>"request_staff","type"=>"string" ,"editor"=>"textFieldBlank,width:50");		
	...
	//${$col}[1]=array("name"=>"pr_status","type"=>"string","editor"=>"textFieldBlank,width:70","df"=>"" );						
	${$col}[1]=array("name"=>"item_code","type"=>"string","editor"=>"textFieldBlank,width:100","df"=>"" );						
	${$col}[2]=array("name"=>"item_name","type"=>"string","editor"=>"textFieldBlank,width:140","df"=>"" );						
	${$col}[3]=array("name"=>"supply_name","type"=>"string","editor"=>"textFieldBlank,width:80","df"=>"" );
	${$col}[4]=array("name"=>"ref_doc","type"=>"string","editor"=>"textFieldBlank,width:80","df"=>"" );
	${$col}[5]=array("name"=>"order_qty","type"=>"string","editor"=>"textFieldBlank,width:80","df"=>"" );
	${$col}[6]=array("name"=>"received_qty","type"=>"string","editor"=>"textFieldBlank,width:80","df"=>"" );
	${$col}[7]=array("name"=>"notes","type"=>"string","editor"=>"textFieldBlank,width:110","df"=>"" );						
	${$col}[8]=array("name"=>"cancel_reason","type"=>"string","editor"=>"textFieldBlank,width:110","df"=>"" );
