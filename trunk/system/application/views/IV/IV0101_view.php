...
Ext.onReady(function(){
	...
	function <?=$cname?>OnSelect(combo,value)
	{
		...
		titemCom = Ext.getCmp('ext-comp-1065'); 
		tlocaCom  = Ext.getCmp('ext-comp-1066'); 
        ...
        obj["params"]["notlike"] = item_code;

        titemCom.clearValue();
    	itemDesStore.load(obj);
	...
	function <?=$cname?>OnSelect(combo,value)
	{
		selDItem = combo.getValue();
		var obj = new Object();
	    obj["params"] = new Object();
	    obj["params"]["item"] = selDItem;
...
//_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_
	...
	var rightComp = [transDate,transQty,itemDesCombo,locaDesCombo];
