...
<?php
	...
	$colD[1]	=	array("name"=>	"location_name"	,"type"=>	"string");						
	$colD[2]	=	array("name"=>	"qty"	,"type"=>	"number");
	$colD[3]	=	array("name"=>	"last_received_date"	,"type"=>	"datetime");
	$colD[4]	=	array("name"=>	"last_issue_date"	,"type"=>	"datetime");
...
recvNoField["name"] = 'item_code';
recvNoField["fieldLabel"] = '<?=lang('item_code')?>';
...
Ext.onReady(function(){
	...
	<?php 
		...
		for($i=0; $i < count($colD) ; $i++){
	    	...
	    	if($i == 2 ) echo ",renderer: num_rend,align:'right'";
	    	echo "}";
	    }
	?>
	     ]
