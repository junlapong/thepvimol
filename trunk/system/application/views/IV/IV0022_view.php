...
function <?=$cname?>OnSelect(combo,value)
{
	var refCom = Ext.getCmp('ext-comp-1044'); 
	refCom.setReadOnly(true);
...
{
    itemStore.removeAll();
	var selJobNo = combo.getValue();
	var itemCom = Ext.getCmp('ext-comp-1005'); 
    var obj = new Object();
    obj["params"] = new Object();
    obj["params"]["query"] = selJobNo;
    itemCom.clearValue(); 
    itemStore.load(obj);
...
//_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_
	...
	// <-- End Grid Header
	var leftComp  = [issueNo,refDocCombo,uiReasonCombo ];
