<?php
class IV0080_model extends MY_Model {  
	
    function IV0080_model(){  
    	parent::MY_Model();
   ...
   function getInvFIFO($con){
     	...
     	$query = "	select item_code, location_code, lot_no, seq_no, current_stock_qty
					...
					where ilm.item_code = '".$con."' and current_stock_qty > 0 and location_code not like 'K%'
    ...
    function locationCodeList($con){
    	...
    	$this->db->not_like('location_code','K','after');
