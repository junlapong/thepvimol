...
// $Id: calendar-setup.js,v 1.1 2009/10/12 12:11:46 Junlapong Exp $
...
Zapatec.Calendar.setup = function (params) {
	...
	param_default("dateStatusFunc", true); //params["disableFunc"]);	// takes precedence if both are defined
	...
	function onSelect(cal) {
		...
		if (update && p.inputField) {
			...
			// NOTE: 2009/05/20 Junlapong : use jquery to trig change event
			// for bind change event of date choose dateFrom, dateTo
